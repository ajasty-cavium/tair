 ...
 *
 *
 * Version: $Id: group_info.hpp 2784 2014-07-21 07:00:55Z mobing $
 *
 * Authors:
...
namespace tair {
  namespace config_server {
    ...
    public:
      ...
      int update_area_capacity_list(const char *group_file_name, const char *group_name, uint32_t area_num, const char *quota);
      int add_area_capacity_list(const char *group_file_name, const char *group_name, const char *area_key, uint32_t &area_num, const char *quota);
