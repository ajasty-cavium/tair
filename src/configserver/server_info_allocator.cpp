 ...
 *
 * Version: $Id: server_info_allocator.cpp 2922 2014-09-05 08:25:26Z yunhen $
 *
 * Authors:
...
namespace tair {
  namespace config_server {
    ...
    server_info *server_info_allocator::new_server_info(group_info * group, uint64_t id, easy_io_t *eio, bool is_cs_server_info)
    {
