 ...
 *
 *
 * Version: $Id: server_conf_thread.hpp 2922 2014-09-05 08:25:26Z yunhen $
 *
 * Authors:
...
namespace tair {
  namespace config_server {
    ...
    private:
      ...
      int set_area_quota(const char *area_key, const char *quota, const char *group_name, const char *group_file_name, bool new_area, uint32_t *new_area_num);
      ...
      bool check_replace_ds_params(std::map<uint64_t, uint64_t>& replace_ds_pairs, const std::vector<std::string>& params);
