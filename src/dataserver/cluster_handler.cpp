...
namespace tair {
  ...
  cJSON* ClusterHandler::Config::to_json() const {
    /*
     *      {
     *        "master": "10.232.4.22:5199",
     *        "slave": "10.232.4.23:5199",
     *        "group": "group3",
     *        "queuelimit": 800,
     *        "timeout": 2000,
     *        "type": "remote",
...
//  }
  ...
  std::string ClusterHandler::id() const
  { return master() + "#" + group_name() + "@" + unit(); }

  std::string ClusterHandler::sid() const
  { return group_name() + "@" + unit(); }

  int ClusterHandler::get_type() const
  { return type(); }

  std::string ClusterHandler::get_unit() const
  { return unit(); }

  std::string ClusterHandler::get_group_name() const
  { return group_name(); }
  ...
  void ClusterHandler::set_rsync_mode(bool rsync)
  { rsync_ = rsync; }
  ...
  std::string ClusterHandler::info() const
  { return config_ == NULL ? "" : config_->info_; }

  std::string ClusterHandler::master() const
  { return config_ == NULL ? "" : config_->master_cs_addr_; }

  std::string ClusterHandler::slave() const
  { return config_ == NULL ? "" : config_->slave_cs_addr_; }

  std::string ClusterHandler::group_name() const
  { return config_ == NULL ? "" : config_->group_name_; }

  std::string ClusterHandler::unit() const
  { return config_ == NULL ? "" : config_->unit_; }
  ...
  int ClusterHandler::type() const
  { return config_ == NULL ? RSYNC_SELF : config_->type_; }
