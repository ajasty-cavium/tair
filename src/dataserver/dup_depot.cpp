 ...
 *
 * Version: $Id: dup_depot.cpp 1683 2013-07-11 03:32:55Z mobing $
 *
 * Authors:
...
namespace tair
{
  ...
  int DupDepot::init()
  {
    ...
    {
      // use update_log
      const char *log_file_name = TBSYS_CONFIG.getString(TAIRSERVER_SECTION, TAIR_ULOG_FAILOVER_BASENAME, TAIR_ULOG_FAILOVER_DEFAULT_BASENAME);
  ...
  void DupDepot::add(tair::sn_operation_type type, tair::common::data_entry& key, tair::common::data_entry& value, int32_t bucket_number)
  {
