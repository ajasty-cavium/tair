 ...
 *
 * Version: $Id: migrate_manager.cpp 2935 2014-09-09 09:35:24Z yunhen $
 *
 * Authors:
...
bool migrate_manager::migrate_log(int db_id, vector<uint64_t> dest_servers, lsn_type start_lsn, lsn_type end_lsn)
{
  ...
  log_info("begin scan, db_id is %d, start_lsn is %"PRI64_PREFIX"u, end_lsn is %"PRI64_PREFIX"u", db_id, start_lsn, end_lsn);
