 ...
 *
 * Version: $Id: recovery_manager.hpp
 *
 * Authors:
...
namespace tair {
   ...
   recovery_manager::recovery_manager(base_duplicator *this_duplicator, tair_manager *tair_mgr, tair::storage::storage_manager *storage_mgr)
   {
   ...
   recovery_manager::~recovery_manager()
  {
   ...
   void recovery_manager::set_recovery_server_list(bucket_server_map recovery_server_list, uint32_t server_version, uint32_t transition_version)
   {
      TAIR_SLEEP(_stop, 1);
