 ...
 *
 *
 * Version: $Id: duplicate_base.hpp 2256 2014-03-17 08:48:19Z mingmin.xmm@alibaba-inc.com $
 *
 * Authors:
...
namespace tair{
   ...
   public:
      ...
      virtual int duplicate_batch_data(int bucket_number, const mput_record_vec* record_vec, const std::vector<uint64_t>& des_server_ids,base_packet *request) { return TAIR_RETURN_SUCCESS;}
   };
}
#endif
