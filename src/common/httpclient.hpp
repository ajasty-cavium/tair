  ...
  namespace Net {
    ...
    class HttpWebResponse
    {
      public:
        ...
        inline const std::string& GetHeader(const std::string& name)
        { return header_.Get(name); }
        inline const std::string& GetProtocolVersion()
        { return version_; }
        inline const std::string& GetResponseUri()
        { return uri_; }
