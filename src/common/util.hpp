 ...
 *
 * Version: $Id: util.hpp 2922 2014-09-05 08:25:26Z yunhen $
 *
 * Authors:
...
namespace tair
{
   namespace util
   {
     ...
     public:
      ...
      public:
        static int change_conf(const char *group_file_name, const char *section_name, const char *key, const char *value, int change_type = CHANGE_FILE_MODIFY, char key_delimiter = '=');
