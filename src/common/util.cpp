 ...
 *
 * Version: $Id: util.cpp 2922 2014-09-05 08:25:26Z yunhen $
 *
 * Authors:
...
namespace tair {
  namespace util {
    ...
    int file_util::change_conf(const char *group_file_name, const char *section_name, const char *key, const char *value, int change_type, char key_delimiter){
