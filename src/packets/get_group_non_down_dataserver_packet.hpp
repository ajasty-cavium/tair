 ...
 *
 * this packet is for client to get non down host of a group from configserver
 *
 * Version: $Id: get_group_non_down_dataserver_packet.hpp 2640 2014-08-25 14:50:30Z huan.wanghaun@alibaba-inc.com $
 *
 * Authors:
 *   huan.wanghuan <huan.wanghaun@alibaba-inc.com>
 *     - initial release
 *
 */
