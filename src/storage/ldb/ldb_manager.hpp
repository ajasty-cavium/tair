 ...
 *
 * Version: $Id: ldb_manager.hpp 2897 2014-08-26 03:02:13Z mobing $
 *
 * Authors:
  ...
  namespace storage
  {
    namespace ldb
    {
      ...
      public:
        ...
        int incr_decr(int bucket, data_entry &key, uint64_t delta, uint64_t init, bool is_incr, int expire, uint64_t &result, data_entry *new_value = NULL);
