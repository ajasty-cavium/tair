 ...
 * ldb stat manager
 *
 * Version: $Id: ldb_stat_manager.hpp 1543 2013-05-27 03:25:43Z nayan $
 *
 * Authors:
...
namespace tair
{
  namespace storage
  {
    namespace ldb
    {
      ...
      private:
        int revise_phyiscal_stat(volatile bool& stop, LdbInstance* db, LDB_STAT& stat, int64_t sleep_interval, int32_t sleep_time);
        int revise_user_stat(volatile bool& stop, LdbInstance* db, LDB_STAT& stat, int64_t sleep_interval, int32_t sleep_time);
