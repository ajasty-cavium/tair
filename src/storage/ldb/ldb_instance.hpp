 ...
 *
 * Version: $Id: ldb_instance.hpp 2640 2014-06-20 03:50:30Z mingmin.xmm@alibaba-inc.com $
 *
 * Authors:
    ...
    namespace ldb
    {
      ...
      public:
        ...
        int update(int bucket_number, tair::common::data_entry& key, tair::common::data_entry& value,
            uint8_t ldb_update_type, bool version_care, int expire_time, bool mc_ops=true, tair::common::data_entry *new_data = NULL);
        int add(int bucket_number, tair::common::data_entry& key, tair::common::data_entry& value, bool version_care, int expire_time);
      ...
      private:
        ...
        int do_get(LdbKey& ldb_key, std::string& value, bool from_cache, bool fill_cache, bool update_stat = true, bool mc_ops=false);
