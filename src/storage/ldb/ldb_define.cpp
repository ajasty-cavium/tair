 ...
 *
 * Version: $Id: ldb_define.cpp 2782 2014-07-21 06:11:41Z mobing $
 *
 * Authors:
  ...
  namespace storage
  {
    namespace ldb
    {
      ...
      bool do_file_repair_check(leveldb::Iterator* iter, leveldb::ManualCompactionType type, leveldb::Logger* info_log)
      {
        ...
        if (type == leveldb::KCompactSelfRepairRemoveExtraSSTFile || type == leveldb::KCompactSelfRepairRemoveCorruptionSSTFile)
        {
