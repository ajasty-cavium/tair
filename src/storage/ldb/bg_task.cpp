 ...
 *
 * Version: $Id: bg_task.cpp 2085 2014-01-10 05:47:06Z mobing $
 *
 * Authors:
  ...
  namespace storage
  {
    namespace ldb
    {
      ...
      void LdbCleanTask::do_clean()
      {
        ...
        const std::string db_backup_dir = std::string(db_->db_path()) + std::string("/") + std::string(leveldb::DBImpl::GetBackupDir()) + std::string("/");
