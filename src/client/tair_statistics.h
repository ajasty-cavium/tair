...
class tair_statistics
{
  ...
  */
  ...
  /*
    ...
    e.g.
    "10.232.4.17:15002:0"     -> [a0, b0, c0, d0, e0, f0, ...]
    "10.232.4.17:15002:65535" -> [a1, b1, c1, d1, e1, f1, ...]
    "10.232.4.18:15002:0"     -> [a2, b2, c2, d2, e2, f2, ...]
    "10.232.4.18:15002:65535" -> [a3, b3, c3, d3, e3, f3, ...]

    10.232.4.17:15002:65535, 10.232.4.17:15002, means server ip:port, 65535 means area.
  ...
  */
  ...
  /*
    @return  the area stat data,
    e.g.
    "10.232.4.17:15002" -> [p0, q0, r0, s0, t0, u0, ...]
    "10.232.4.18:15002" -> [p1, q1, r1, s1, t1, u1, ...]

    10.232.4.17:15002, 10.232.4.18:15002 means server ip:port.
...
private:
  void load_data(const std::vector<std::string>& desc, const std::map<uint64_t, std::vector<int64_t> >& original_stat);
  void clear();
