 ...
 *
 *
 * Version: $Id: tair_client.hpp 2935 2014-09-09 09:35:24Z yunhen $
 *
 * Authors:
  ...
  class tair_client {
    public:
      ...
      public:
        ...
        static bool sort_total(flow_sort_item i, flow_sort_item j) { return ((i.rate.in + i.rate.out) > (j.rate.in + j.rate.out)); }
      };
