 ...
 * Version: $Id: i_tair_client_impl.hpp 2935 2014-09-09 09:35:24Z yunhen $
 *
 * Authors:
...
namespace tair
{
  ...
  public:
    ...
    virtual int query_from_dataserver(uint64_t serverId, tair_statistics& stat_info)
    { return TAIR_RETURN_NOT_SUPPORTED; }
    ...
    virtual int set_flow_limit_bound(int ns, int lower, int upper, tair::stat::FlowType type) { return TAIR_RETURN_NOT_SUPPORTED; }
    ...
    virtual int alloc_area_quota(long quota, int *new_area)
    { return TAIR_RETURN_NOT_SUPPORTED; }

    virtual int modify_area_quota(int area, long quota)
    { return TAIR_RETURN_NOT_SUPPORTED; }

    virtual int clear_area(int area)
    { return TAIR_RETURN_NOT_SUPPORTED; }

    virtual int get_flow(uint64_t addr, int ns, tair::stat::Flowrate &rate)
    { return TAIR_RETURN_NOT_SUPPORTED; }

    virtual int get_servers(std::set<uint64_t> &servers)
    { return TAIR_RETURN_NOT_SUPPORTED; }
